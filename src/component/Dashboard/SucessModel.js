    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          <div style={{ fontSize: 14, fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center',color:'black' }}>
            Appoinment Schedule has been updated
          </div>

          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', margin: 20 }}>
            <Button style={{ backgroundColor: "#e67e22", color: '#fff' }}  onClick={handleClose} >Thank you</Button>
